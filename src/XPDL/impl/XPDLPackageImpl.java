...
import XPDL.ActivityXPDL;
import XPDL.NamedElement;
import XPDL.Pool;
...
public class XPDLPackageImpl extends EPackageImpl implements XPDLPackage {
	 ...
	 * @generated
	 */
	private EClass activityXPDLEClass = null;
	 ...
	 * @generated
	 */
	public EClass getActivityXPDL() {
		return activityXPDLEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getActivityXPDL_Id() {
		return (EAttribute)activityXPDLEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		activityXPDLEClass = createEClass(ACTIVITY_XPDL);
		createEAttribute(activityXPDLEClass, ACTIVITY_XPDL__ID);
	...
	public void initializePackageContents() {
		...
		initEClass(activityXPDLEClass, ActivityXPDL.class, "ActivityXPDL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getActivityXPDL_Id(), ecorePackage.getEString(), "id", null, 0, 1, ActivityXPDL.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(processEClass, process.class, "process", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
