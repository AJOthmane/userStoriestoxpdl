...
public class XPDLAdapterFactory extends AdapterFactoryImpl {
	...
	protected XPDLSwitch<Adapter> modelSwitch =
		new XPDLSwitch<Adapter>() {
			...
			@Override
			public Adapter caseActivityXPDL(ActivityXPDL object) {
				return createActivityXPDLAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link XPDL.NamedElement <em>Named Element</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link XPDL.ActivityXPDL <em>Activity XPDL</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createActivityXPDLAdapter() {
		return null;
	}
